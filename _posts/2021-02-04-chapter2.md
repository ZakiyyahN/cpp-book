...
expression_ and the _precedence_ of the operators. [anAssignment] 

[anAssignment]: Daniel, L. Y. (2017). _Introduction to Programming With C++_. Pearson College Div.
...
before the definition. The general format for a `const` declaration is shown as below:
