...
> By adding the line `using namespace std;` everyone knows that we are talking about U of R.
> Then whenever we use `cout` (without `std::`) it is just like when we mention the Data Science Lab.
> </details>
