...
1. Prompt user by a printed message to enter their number.

2. Declare a variable in order to store the number that user will enter.

3. Get the user's number through the console.
...
We will talk about the functions in the chapter 6.
...
You entered: <the number user entered>
```
