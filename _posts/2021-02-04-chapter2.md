...
> ##### Note:
> That `cin` (pronounced see-in) stands for _console input_, 
> and `cout` (pronounced see-out) stands for _console output_.
...
expression_ and the _precedence_ of the operators.[^simple]
