...
Writing a program involves[^simple] designing a strategy for solving
...
<blockquote>
    <details>
        ...
        <br>
        Imagine you and a group of your friends from different universities,
        talking about the University of Regina.
        In this group, if you mention a specific place like Data Science Lab,
        everyone can understand you mean the Data Science Lab at the U of R.
        <br>
        On the other hand, Imagine your topic is not U of R.
        You mention the Data Science Lab without mentioning the U of R.
        Your friends cannot understand what place you are talking about.
        <br>
        This is exactly what happens here.
        By adding the line <code>using namespace std;</code> everyone knows that we are talking about U of R.
        Then whenever we use <code>cout</code> (without <code>std::</code>) it is just like when we mention the Data Science Lab.
    </details>
</blockquote>
...
###### 2.2.5 What Is the Variables? How We Can Store a Value in a Variable?
...
###### 2.2.6 Get the Entered Number of  the User and Store It in Variable
...
###### 2.2.8 How Does a Computer Know a Program Has Been Finished Successfully?
...
-   The first 19 lines of the code is *comment block* which makes a brief 
...
expression_ and the _precedence_ of the operators. [^3]

[^3]: Liang, D. Y. (2013a). Introduction to Programming with C++ (Myprogramminglab) (3rd ed.). Pearson.
...
- #### 2. Explicit Operator Conversion-type-id (since C++11)
    ...
    > Declares a user-defined conversion function that participates in 
...
In software engineering, a _software development process_ is the process of dividing 
software development work into distinct phases to improve design, product management, 
and project management. It is also known as a _software development life cycle_ (SDLC). 
