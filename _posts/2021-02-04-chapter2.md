...
You need to store it in the computer memory, and use it during the program 
...
###### 2.2.6 Get the entered number of user and store it in variable
...
###### 2.2.7 Get the entered number of user and store it in variable
