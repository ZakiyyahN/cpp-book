...
Almost without exception, this will be a logical (Boolean) expression; if not, its value is implicitly coerced to type `bool`

> Nonzero value means true, zero value means false.
...
running properly.[^test]

[^test]: Something just for test
