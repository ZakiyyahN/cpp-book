...
- In each line of a code, you should know the value of each variable; if you are not sure about them, print them out.
  ...
  > the statement changes its value.
  > 
...
In some specific statement a breakpoint can be set out. we need to ignore some statements to see the effect of the rest of the program.
