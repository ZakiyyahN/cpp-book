...
Here is an example which also shows a compound expression:
...
<details>
<summary>
	<b>Should curly braces appear on their own line?</b>
</summary>
...
The characters `"You are "` are sent to the output stream. <br>The
expression `age >= 65` is evaluated. <br>If the result is `true`, the
