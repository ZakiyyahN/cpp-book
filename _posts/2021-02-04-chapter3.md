...
Almost without exception, this will be a logical (Boolean) expression; 
if not, its value is implicitly coerced to type `bool`.
...
If you have only one line of statement, you are able to take the braces off. But this method is **not recommanded** at all.
