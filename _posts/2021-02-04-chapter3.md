...
```cpp
int number1= 3;
int number2 = - number1; // number2 = -3 (Positive become negative)
int number3 = - number2; // number3 = 3 (Negative become positive)
```
...
```
#### 3.2.6 Modulo - Remainder Division `%`
>Add photo here
```cpp
int number1 = 7;
int number2 = 2;
