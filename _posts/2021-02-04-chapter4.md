...
The focus of this chapter is to introduce **cmath** library and various mathematical functions, character 
and strings, and also the functions which can be used to work with these two variable types.
